...
<body <?php body_class();?> style="background: <?php echo $color;?> url(<?php echo $img;?>)fixed;">
	...
	<header>
		...
		?>
		<nav class="top-navigation flex  align-center" style="position: <?php is_user_logged_in() ? $position = "relative" : $position = "fixed"; echo $position;?> ">
			<div class="burger">
			...
			wp_nav_menu(array(
				...
				<div class="nav-register flex poiret margin">
					...
					<a href="/wp-admin/post-new.php?post_type=artysts"><?php _e("Добавить+",WP_HOME);?></a>
					<?
					else:?>
